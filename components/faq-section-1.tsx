...
const faqs = [
  {
    question: "Is Nexora Global free to use?",
  ...
  {
    question: "What integrations does Nexora Global support?",
    answer:
      "Nexora Global integrates with popular tools like Slack, Google Workspace, Trello, and many more. Check our documentation for the full list.",
  },
]
