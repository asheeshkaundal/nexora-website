  ...
  return (
    <main>
      ...
      <div className="min-h-screen bg-gray-900 flex items-center justify-center p-2 sm:p-4">
        ...
        <div className="relative bg-white rounded-2xl sm:rounded-3xl shadow-2xl w-full max-w-6xl h-[90vh] flex flex-col overflow-hidden">
          ...
          <div className="flex-shrink-0 px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 lg:gap-6">
              ...
              <div className="lg:flex-1 lg:text-right">
                <p className="text-gray-600 text-sm sm:text-base max-w-none lg:max-w-xl lg:ml-auto">
          ...
          <div className="flex-1 overflow-y-auto px-4 sm:px-6 lg:px-8 pb-4 sm:pb-6">
            <div className="grid lg:grid-cols-2 gap-4 lg:gap-6 h-full">
              ...
              <div className="bg-gray-50 rounded-xl p-4 sm:p-5 lg:p-6 h-fit">
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-2.5 px-4 text-sm rounded-lg transition-colors duration-300 transform hover:scale-105"
                  >
                    SEND MESSAGE
                  </button>
                </form>
              ...
              <div className="space-y-4 sm:space-y-5">
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4 mb-4 sm:mb-5">
                    <div className="bg-gray-50 rounded-xl p-3 sm:p-4 flex flex-col items-center text-center">
                      <div className="bg-red-100 p-2 rounded-lg mb-2">
                        <Phone className="w-4 h-4 sm:w-5 sm:h-5 text-red-600" />
                      </div>
                      <h3 className="font-semibold text-gray-800 mb-1 text-xs sm:text-sm">
                        PHONE
                      </h3>
